...
<head>
    ...
    <title>Order Artwork Design</title>
    <style>
        body {
...
<?php include 'navbar.php';?>
    ...
    <div class="container">
        <h1>Order Artwork Design</h1>

        <!-- Image Slider -->
        <div class="slider-container">
            <div class="slides">
                <img src="images/gaming_artwork.png" alt="Artwork 1">
                <img src="images/formal_artwork.png" alt="Artwork 2">
                <img src="images/custom_artwork.jpg" alt="Artwork 3">
            </div>
        ...
        <textarea id="request" rows="6" placeholder="Please select the template and describe your Artwork design request here..."></textarea>
    ...
    <script>
        ...
        const captions = ["Artwork 1", "Artwork 2", "Artwork 3"];
