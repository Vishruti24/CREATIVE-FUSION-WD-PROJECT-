...
<head>
    ...
    <title>Order Banner Design</title>
    <style>
        body {
...
<?php include 'navbar.php';?>
    ...
    <div class="container">
        <h1>Order Banner Design</h1>

        <!-- Image Slider -->
        <div class="slider-container">
            <div class="slides">
                <img src="images/gaming_banner_1.jpg" alt="Banner 1">
                <img src="images/gaming_banner_2.jpg" alt="Banner 2">
                <img src="images/gaming_banner_3.jpeg" alt="Banner 3">
            </div>
        ...
        <textarea id="request" rows="6" placeholder="Please select the template and describe your Banner design request here..."></textarea>
    ...
    <script>
        ...
        const captions = ["Banner 1", "Banner 2", "Banner 3"];
