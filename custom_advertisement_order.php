...
<head>
    ...
    <title>Order Advertisement Design</title>
    <style>
        body {
...
<?php include 'navbar.php';?>
    ...
    <div class="container">
        <h1>Order Advertisement Design</h1>

        <!-- Image Slider -->
        <div class="slider-container">
            <div class="slides">
                <img src="images/custom_advertisement_1.jpg" alt="Advertisement 1">
                <img src="images/custom_advertisement_2.jpg" alt="Advertisement 2">
                <img src="images/custom_advertisement_3.jpg" alt="Advertisement 3">
            </div>
        ...
        <textarea id="request" rows="6" placeholder="Please select the template and describe your Advertisement design request here..."></textarea>
    ...
    <script>
        ...
        const captions = ["Advertisement 1", "Advertisement 2", "Advertisement 3"];
