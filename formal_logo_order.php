...
<head>
    ...
    <style>
        ...
        .slides {
            display: flex;
            width: 350%; /* Total width for 3 images (100% each) */
...
<?php include 'navbar.php';?>
    ...
    <div class="container">
        <h1>Order Logo Design</h1>

        <!-- Image Slider -->
        <div class="slider-container">
            <div class="slides">
                <img src="images/formal_logo_1.png" alt="Logo 1">
                <img src="images/formal_logo_2.png" alt="Logo 2">
                <img src="images/formal_logo_3.png" alt="Logo 3">
            </div>
        ...
        <textarea id="request" rows="6" placeholder="Please select the template and describe your logo design request here..."></textarea>
    ...
    <script>
        ...
        const captions = ["Logo 1", "Logo 2", "Logo 3"];
        const captionElement = document.querySelector('.slider-caption');

        function moveSlider(direction) {
            const totalSlides = captions.length;
            slideIndex = (slideIndex + direction + totalSlides) % totalSlides;
            slides.style.transform = `translateX(-${slideIndex * (100 / totalSlides)}%)`;  // Shift by 100% divided by the total number of images
