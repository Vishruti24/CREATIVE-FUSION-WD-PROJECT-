...
<head>
    ...
    <title>Order Visiting card Design</title>
    <style>
        body {
...
<?php include 'navbar.php';?>
    ...
    <div class="container">
        <h1>Order Visiting card Design</h1>

        <!-- Image Slider -->
        <div class="slider-container">
            <div class="slides">
                <img src="images/visiting_1.jpg" alt="Visiting card 1">
                <img src="images/visiting_2.jpg" alt="Visiting card 2">
                <img src="images/visiting_3.jpg" alt="Visiting card 3">
            </div>
        ...
        <textarea id="request" rows="6" placeholder="Please select the template and describe your Visiting card design request here..."></textarea>
    ...
    <script>
        ...
        const captions = ["Visiting card 1", "Visiting card 2", "Visiting card 3"];
