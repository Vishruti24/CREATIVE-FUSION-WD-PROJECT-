   ...
   <div class="navbar">
	...
	<section class="products">
		...
		<div class="all-products">
			<div class="product">
				<img src="images/gaming_banner.jpg">
				<div class="product-info">
					<h4 class="product-title">Gaming Banner Design
					</h4>
                                    <br>
                                    <p><b>$19/-</b></p>
                                    <a class="product-btn" href="gaming_banner_order.php"><b>Buy Now</b></a>

				</div>
			</div>
			<div class="product">
				<img src="images/formal_banner.jpg">
				<div class="product-info">
					<h4 class="product-title">Formal Banner Design
					</h4>
                                    <br>
                                    <p><b>$19/-</b></p>

                                    <a class="product-btn" href="formal_banner_order.php"><b>Buy Now</b></a>

				</div>
			</div>
			<div class="product">
				<img src="images/custom_baner.png">
				<div class="product-info">
					<h4 class="product-title">Custom Banner Design
					</h4>
                                    <br>
                                    <p><b>$29/-</b></p>
                                    <a class="product-btn" href="custom_banner_order.php"><b>Buy Now</b></a>
