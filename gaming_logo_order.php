...
<head>
    ...
    <style>
        ...
        .slides {
            display: flex;
            width: 300%; /* Total width for 3 images (100% each) */
...
<body>
    ...
    <div class="container">
        ...
        <div class="slider-container">
            <div class="slides">
                <img src="images/gaming_logo_1.jpg" alt="Logo 1">
                <img src="images/gaming_logo_2.jpg" alt="Logo 2">
                <img src="images/gaming_logo_3.jpg" alt="Logo 3">
            </div>
